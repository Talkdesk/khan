Genghis.JSON = {
    parse: function(src) {
        ...
        function replaceCallExpression(src) {
            ...
            // we won't bother using a $kahnType for this one.
            ...
            src = src.replace(/^\s*(new\s+)?(Date|RegExp)(\b)/, '$1kahn$2$3');
        ...
        return (function(node) {
            var __kahn_json__;
            eval('__kahn_json__ = ' + node.source());
            return __kahn_json__;
        })(node);
    },
            ...
            function createView(key, holder) {
                ...
                switch (typeof value) {
                    ...
                    case 'object':
                        ...
                        if (Object.hasOwnProperty.call(value, '$kahnType')) {
                            switch(value.$kahnType) {
                                case 'ObjectId':
